...
import java.util.List;
    ...
    public abstract class TestBase {
        ...
        //Sebebi child classlarda gorulebilmeli
        protected static WebDriver driver;

        //setUp class i olustur
        @Before
        public void setup() {
        ...
        public static void switchTowindow(String targetTitle) {
            ...
            for (String handle : driver.getWindowHandles()) {
                ...
                if (driver.getTitle().equals(targetTitle)) {
                    return;//CIK  break dan daha guclu methodunda dısına cık
                }
            }
            driver.switchTo().window(origin);
        }

        //windowNumber sıfır (0) dan basliyor
        //index numarasini parametre olarak alir ve o indexli pencereye gecis yapilir.
        public static void switchToWindow(int windowNumber) {  //IKI METHODDA ISIM AYNI "SWITCHTOWINDOW" SIKINTI OLMADI
            // CUNKU PARAMETRE FARKLI BIRI STRING DIGERI INTEGER

            List<String> list = new ArrayList<>(driver.getWindowHandles());
            driver.switchTo().window(list.get(windowNumber));
        }

        //Therad.sleep her zaman kullanmak icin
        ...
        public static WebElement waitForClickblility(WebElement element,int timeout) {
            WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(timeout));
